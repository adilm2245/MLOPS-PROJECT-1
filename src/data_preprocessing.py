...
class DataPreprocessor:
    ...
    def select_feature(self,df):
        try:
            ...
            logger.error(f"Error during features selection step {e} ")
            raise CustomException("Error while features selection",e)
    ...
    def process(self):
        try:
            ...
            logger.error(f"Error processing completed successfully{e}")
